...
@section('title', 'Tambah Data Izin Belajar/Kuliah')
    ...
    <div class="animated fadeIn">
        ...
        <div class="card">
            <div class="card-header">
                <div class="pull-left">
                    <strong>Tambah Data Izin Belajar Kuliah</strong>
                </div>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ url('izinbelajar') }}" method="post">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            is-invalid @enderror">
                                ...
                                @foreach ($pegawais as $item)
                                    <option value="{{ $item->id }}" {{ old('pegawaibk_id') == $item->id ? 'selected' : null }}>{{ $item->nama_pegawai}}</option>  
                                @endforeach                                
                            </select>
                            @error('pegawaibk_id')
                            <div class="invalid-feedback">{{ $message }}</div>     
                        ...
                        <div class="form-group">
                            ...
                            is-invalid @enderror">
                                ...
                                @foreach ($pegawais as $item)
                                    <option value="{{ $item->id }}" {{ old('pegawaibk_id') == $item->id ? 'selected' : null }}>{{ $item->nip}}</option>  
                                @endforeach                                
                            </select>
                            @error('pegawaibk_id')
                            <div class="invalid-feedback">{{ $message }}</div>     
                        ...
                        <div class="form-group">
                            ...
                            is-invalid @enderror" value="{{ old('nama_kampus') }}">
                            @error('nama_kampus')
                            <div class="invalid-feedback">{{ $message }}</div>     
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            is-invalid @enderror" value="{{ old('kota') }}">
                            @error('kota')
                            <div class="invalid-feedback">{{ $message }}</div>     
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            is-invalid @enderror" value="{{ old('cabang') }}">
                            @error('cabang')
                            <div class="invalid-feedback">{{ $message }}</div>     
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            is-invalid @enderror" value="{{ old('fakultas') }}">
                            @error('fakultas')
                            <div class="invalid-feedback">{{ $message }}</div>     
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            is-invalid @enderror" value="{{ old('gelar') }}">
                            @error('gelar')
                            <div class="invalid-feedback">{{ $message }}</div>     
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            is-invalid @enderror" value="{{ old('program_studi') }}">
                            @error('program_studi')
                            <div class="invalid-feedback">{{ $message }}</div>     
                            @enderror
                        </div>
