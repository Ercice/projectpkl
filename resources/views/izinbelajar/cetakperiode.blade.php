...
<p class="font">LAPORAN IZIN CUTI BELAJAR/KULIAH</p>
...
<table class="size">
  <tr>
    ...
    <th class="align">Nama Kampus</th>
    <th class="align">Kota</th>
    <th class="align">Cabang</th>
    <th class="align">Fakultas</th>
    <th class="align">Gelar</th>
    <th class="align">Program Studi</th>
  </tr>
  @php $no=1; @endphp
  ...
  <tr>
    ...
    <td class="align">{{ $item->pegawaibk->nip }}</td>
    <td>{{ $item->pegawaibk->nama_pegawai }}</td>
    <td class="align">{{ $item->nama_kampus }}</td>
    <td class="align">{{ $item->kota }}</td>
    <td class="align">{{ $item->cabang }}</td>
    <td class="align">{{ $item->fakultas }}</td>
    <td class="align">{{ $item->gelar }}</td>
    <td class="align">{{ $item->program_studi }}</td>
  </tr>
  @endforeach
</table>
<br><br>
