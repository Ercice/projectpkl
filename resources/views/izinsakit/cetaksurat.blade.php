...
<br>
<p class="bold align font2"><u><b>SURAT IZIN CUTI SAKIT</u><br>
    <b>NOMOR : B-{{$izinsakit->no_surat}}/O.3/Cp.4/11/2021</b></p>
<br><br>
...
<table width="100%">
    <tbody class="font">                  
        <tr>
            ...
            <td width="2%">:</td>
            <td class="bold">{{ $izinsakit->pegawaiskt->nama_pegawai }}</td>
        </tr>
        <tr>
            <td></td>
            <td>N I P / N R P</td>
        ...
        <tr>
            ...
            <td>J a b a t a n</td>
            <td>:</td>
            <td>{{ $izinsakit->pegawaiskt->jabatan }}</td>
        </tr>
        <tr>
            <td></td>
            <td>Satuan Organisasi</td>
            <td>:</td>
            <td>{{ $izinsakit->pegawaiskt->pangkat }}</td>
        </tr>
...
<table width="100%">
    <tr>
        ...
        <td  class="align2 font">
            ...
            <p>Dengan ini mengajukan permintaan Cuti Sakit mulai tanggal {{ Carbon\Carbon::parse( $izinsakit->tglmulai )->translatedFormat('d F Y') }} sampai dengan waktu
                yang tidak bisa ditentukan karena saya menderita sakit "{{$izinsakit->jenis_sakit}}" sesuai dengan keterangan dokter/bidan yang terlampir.
            </p>
        </td>
...
<table  width="100%">
    <tbody>
        <tr  class="align2 font">
            <td>Demikianlah surat Izin Cuti Sakit ini dibuat untuk dapat digunakan sebagaimana mestinya.</td>
        </tr>
    </tbody>
    <br><br><br>
</table>
